...
const CARD_DATA = {
  ...
  continue: [
    { title: "The Day We Met", tag: "Pilot Episode", desc: "Night of garba we really met for the first time ,talked for the first time ,tune chasma manga tha merese game khelne ke liye we did babuji wala dance hahaha we lay down on the gorund we laughed hahaha the night was i guess the night of begining .", genre: "Origin Story", progress: 92, image: "" },
